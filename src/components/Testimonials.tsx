...
const Testimonials = () => (
  <section id="clients" className={`${styles.paddingY} ${styles.flexCenter} flex-col relative`} aria-labelledby="testimonials-heading">
...
{/* Feedback Cards */}
    <div className="flex flex-wrap sm:justify-start justify-center w-full feedback-container relative z-[1]" role="list">
      {feedback.map((card) => (
